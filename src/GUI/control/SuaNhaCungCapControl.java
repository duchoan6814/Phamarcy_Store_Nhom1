...
public class SuaNhaCungCapControl implements Initializable {
	...
	public SuaNhaCungCapControl(QuanLyNCCConTrol conTrol, NhaCungCap nhaCungCap) {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		txtTitle.setText("Sửa Nhà Cung Cấp");
		btnThem.setText("Sửa");
	...
	private void initMaNhaCungCap() {
		...
		txtMaNhaCungCap.setText(nhaCungCap.getId());
	...
	private void initDiaChi() {
		...
		if (diaChi != null) {
			String[] soNha = nhaCungCap.getDiaChi().split(" - ");
			txtSoNha.setText(soNha[0]);
			listXa.add(soNha[1]);
			cmbPhuong.setValue(soNha[1]);
			listQuan.add(soNha[2]);
			cmbQuan.setValue(soNha[2]);
			listTinh.add(soNha[3]);
			cmbTinh.setValue(soNha[3]);
		}
	}

	private void initXa() {
		// TODO Auto-generated method stub
		listXa = FXCollections.observableArrayList();
		cmbPhuong.setValue("");
	...
	private void initQuanHuyen() {
		// TODO Auto-generated method stub
		listQuan = FXCollections.observableArrayList();
	...
	private void initTrangChu() {
		// TODO Auto-generated method stub
		txtTrangChu.setText(nhaCungCap.getTrangChu());
	...
	private void initGmail() {
		// TODO Auto-generated method stub
		txtFAX.setText(nhaCungCap.getEmail());
